...
#download file
driver.get('https://redash.prd.data.contentful.org/api/queries/1875/results.csv?api_key=siHfhSSo5VOZwrTTP0R434dgRJAc8hp03GZsfeRL')
time.sleep(3)
...
#BEGIN LOOP
    ...
    for row in reader:
        ...
        time.sleep(2)
        driver.find_element_by_xpath("/html/body/div[3]/div/div[1]/div/table/tbody/tr/td[2]/div[4]/div[1]/div/div[2]/div/div/div/div[2]/div/div[2]/div/form/table/tbody/tr[10]/td/select").send_keys("Batch13 (Trial and Test Accounts - DO NOT BILL)")
